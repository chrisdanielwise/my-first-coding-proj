...
int main() {
 FILE * in = fopen("C:\\Users\\USER\\OneDrive\\Desktop\\web\\c programming\\input and output\\paydata.txt", "r");
 FILE * out = fopen("C:\\Users\\USER\\OneDrive\\Desktop\\web\\c programming\\input and output\\payroll.txt", "w");
